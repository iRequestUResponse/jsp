						...
						<div class="text-center">
							<ul class="pagination">
								...
								<c:choose>
									...
									<c:otherwise>
									    <li>
									      <a href="${ cp }/userPagingList?page=${ param.page - 1 }&size=10" aria-label="Previous">									
									        <span aria-hidden="true">&laquo;</span>
									      </a>
									</c:otherwise>
								</c:choose>
								...
								<c:forEach var="page" begin="1" end="${ paginationSize }">
									<c:choose>
										...
										<c:otherwise>
											<li><a href="${ cp }/userPagingList?page=${ page }&size=10">${ page }</a></li>							
										</c:otherwise>
									</c:choose>
								</c:forEach>
								<c:choose>
									...
									<c:otherwise>
									    <li>
									      <a href="${ cp }/userPagingList?page=${ param.page + 1 }&size=10" aria-label="Next">
									        <span aria-hidden="true">&raquo;</span>
									      </a>
									</c:otherwise>
								</c:choose>
